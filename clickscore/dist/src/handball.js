  ...
  return false;
        ...
        selectFaq.addEventListener('change', () => {
          ...
          if (selectFaq.value == 'faq_skills') {
              faqExpl.innerHTML += `Umiejętności drużyn to najważniejszy element rozgrywki aby określić siłę danego zespołu. W symulatorze piłki ręcznej mamy do wybrania takie skille: <br>
              Att - atak (odpowiedzialny za ilość strzałow danej drużyny)<br>
