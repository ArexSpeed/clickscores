  ...
  return false;
        ...
        selectFaq.addEventListener('change', () => {
          ...
          if (selectFaq.value == 'faq_ligi') {
              ...
              Att - atak<br>
              Def - defensywa<br>
              TW - zgranie zespołu (team work)<br>
          ...
          if (selectFaq.value == 'faq_skills') {
              faqExpl.innerHTML += `Umiejętności drużyn to najważniejszy element rozgrywki aby określić siłę danego zespołu. W symulatorze koszykarskim mamy do wybrania takie skille: <br>
              Att - atak (odpowiedzialny za ilość rzutów danej drużyny)<br>
              Def - defensywa (odpowiedzialna za obrone drużyny by zminimalizować jak najbardziej strzały przeciwnika)<br>
              TW - zgranie zespołu wpływa zarówno na atak jak i obrone drużyny<br> `
          }
          ...
          if (selectFaq.value == 'faq_plays') {
              ...
              Stosunek wygranych do rozegranych meczów (punktacja jak w NBA)<br>
          ...
          if (selectFaq.value == 'faq_cups') {
              faqExpl.innerHTML += `
              Do dyspozycji są także rozgrywki pucharowe. Wybierając w "Select League" odpowiednią opcję np. "World Cup" pojawiają się drużyny występujące w tych rozgrywkach. <br>Nazwy i umiejętności mozesz oczywiscie zmieniać na swoje drużyny ale kolejność uzupełniania ma znaczenie ponieważ wybrane zespoły są dzielone kolejno do odpowiednich grup tzn. pierwsze 4 drużyny do Grupy A, kolejne cztery do Grupy B, następne do Gr C itd.<br>
              `
          }
      })
          ...
          let nums = []; //teams rand
            ...
            for (let i = 0; i < teams_qty; i++) {
              let rnd = Math.floor(Math.random()*nums.length);
                ...
                let new_tw = document.querySelector(`#team${n}_tw`).value;
...
if(new_teams.length == 4){
  ...
  <tr>  
  <td>1</td><td>${lt[0].name}</td><td>${lt[0].match}</td><td>${lt[0].win}</td><td></td><td>${lt[0].lose}</td><td>${lt[0].pts_minus_sum}</td><td>${lt[0].pts_minus_sum}</td><td>${lt[0].points}</td>
  </tr>
  <tr>  
  <td>2</td><td>${lt[1].name}</td><td>${lt[1].match}</td><td>${lt[1].win}</td><td></td><td>${lt[1].lose}</td><td>${lt[1].pts_minus_sum}</td><td>${lt[1].pts_minus_sum}</td><td>${lt[1].points}</td>
  </tr>
  <tr>
   <td>3</td><td>${lt[2].name}</td><td>${lt[2].match}</td><td>${lt[2].win}</td><td></td><td>${lt[2].lose}</td><td>${lt[2].pts_minus_sum}</td><td>${lt[2].pts_minus_sum}</td><td>${lt[2].points}</td>
  </tr>
  <tr>
  <td>4</td><td>${lt[3].name}</td><td>${lt[3].match}</td><td>${lt[3].win}</td><td></td><td>${lt[3].lose}</td><td>${lt[3].pts_minus_sum}</td><td>${lt[3].pts_minus_sum}</td><td>${lt[3].points}</td>
  </tr>
...
if(new_teams.length == 6){
  ...
  <tr>  
  <td>5</td><td>${lt[4].name}</td><td>${lt[4].match}</td><td>${lt[4].win}</td><td></td><td>${lt[4].lose}</td><td>${lt[4].pts_minus_sum}</td><td>${lt[4].pts_minus_sum}</td><td>${lt[4].points}</td>
  </tr>
  <tr>
  <td>6</td><td>${lt[5].name}</td><td>${lt[5].match}</td><td>${lt[5].win}</td><td></td><td>${lt[5].lose}</td><td>${lt[5].pts_minus_sum}</td><td>${lt[5].pts_minus_sum}</td><td>${lt[5].points}</td>
  </tr>
...
if(new_teams.length == 8){
  ...
  <tr>
   <td>7</td><td>${lt[6].name}</td><td>${lt[6].match}</td><td>${lt[6].win}</td><td></td><td>${lt[6].lose}</td><td>${lt[6].pts_minus_sum}</td><td>${lt[6].pts_minus_sum}</td><td>${lt[6].points}</td>
  </tr>
  <tr>
  <td>8</td><td>${lt[7].name}</td><td>${lt[7].match}</td><td>${lt[7].win}</td><td></td><td>${lt[7].lose}</td><td>${lt[7].pts_minus_sum}</td><td>${lt[7].pts_minus_sum}</td><td>${lt[7].points}</td>
  </tr>
...
if(new_teams.length == 10){
  ...
  <tr>  
  <td>9</td><td>${lt[8].name}</td><td>${lt[8].match}</td><td>${lt[8].win}</td><td></td><td>${lt[8].lose}</td><td>${lt[8].pts_minus_sum}</td><td>${lt[8].pts_minus_sum}</td><td>${lt[8].points}</td>
  </tr>
  <tr>
  <td>10</td><td>${lt[9].name}</td><td>${lt[9].match}</td><td>${lt[9].win}</td><td></td><td>${lt[9].lose}</td><td>${lt[9].pts_minus_sum}</td><td>${lt[9].pts_minus_sum}</td><td>${lt[9].points}</td>
  </tr>
  <tr>
...
if(new_teams.length == 12){
  ...
  <tr>
   <td>11</td><td>${lt[10].name}</td><td>${lt[10].match}</td><td>${lt[10].win}</td><td></td><td>${lt[10].lose}</td><td>${lt[10].pts_minus_sum}</td><td>${lt[10].pts_minus_sum}</td><td>${lt[10].points}</td>
  </tr>
  <tr>
  <td>12</td><td>${lt[11].name}</td><td>${lt[11].match}</td><td>${lt[11].win}</td><td></td><td>${lt[11].lose}</td><td>${lt[11].pts_minus_sum}</td><td>${lt[11].pts_minus_sum}</td><td>${lt[11].points}</td>
  </tr>
...
if(new_teams.length == 14){
  ...
  <tr>  
  <td>13</td><td>${lt[12].name}</td><td>${lt[12].match}</td><td>${lt[12].win}</td><td></td><td>${lt[12].lose}</td><td>${lt[12].pts_minus_sum}</td><td>${lt[12].pts_minus_sum}</td><td>${lt[12].points}</td>
  </tr>
  <tr>
  <td>14</td><td>${lt[13].name}</td><td>${lt[13].match}</td><td>${lt[13].win}</td><td></td><td>${lt[13].lose}</td><td>${lt[13].pts_minus_sum}</td><td>${lt[13].pts_minus_sum}</td><td>${lt[13].points}</td>
  </tr>
...
if(new_teams.length == 16){
  ...
  <tr>
   <td>15</td><td>${lt[14].name}</td><td>${lt[14].match}</td><td>${lt[14].win}</td><td></td><td>${lt[14].lose}</td><td>${lt[14].pts_minus_sum}</td><td>${lt[14].pts_minus_sum}</td><td>${lt[14].points}</td>
  </tr>
  <tr>
  <td>16</td><td>${lt[15].name}</td><td>${lt[15].match}</td><td>${lt[15].win}</td><td></td><td>${lt[15].lose}</td><td>${lt[15].pts_minus_sum}</td><td>${lt[15].pts_minus_sum}</td><td>${lt[15].points}</td>
  </tr>
...
if(new_teams.length == 18){
  tableSort.innerHTML = `<table>
                    ...
                    <tr>  
                    <td>17</td><td>${lt[16].name}</td><td>${lt[16].match}</td><td>${lt[16].win}</td><td></td><td>${lt[16].lose}</td><td>${lt[16].pts_minus_sum}</td><td>${lt[16].pts_minus_sum}</td><td>${lt[16].points}</td>
                    </tr>
                    <tr>
                    <td>18</td><td>${lt[17].name}</td><td>${lt[17].match}</td><td>${lt[17].win}</td><td></td><td>${lt[17].lose}</td><td>${lt[17].pts_minus_sum}</td><td>${lt[17].pts_minus_sum}</td><td>${lt[17].points}</td>
                    </tr>                   
      </table>   `
}
    ...
    if(new_teams.length == 20){
     tableSort.innerHTML = `<table>
                    ...
                    <tr>
                     <td>19</td><td>${lt[18].name}</td><td>${lt[18].match}</td><td>${lt[18].win}</td><td></td><td>${lt[18].lose}</td><td>${lt[18].pts_minus_sum}</td><td>${lt[18].pts_minus_sum}</td><td>${lt[18].points}</td>
                    </tr>
                    <tr>
                    <td>20</td><td>${lt[19].name}</td><td>${lt[19].match}</td><td>${lt[19].win}</td><td></td><td>${lt[19].lose}</td><td>${lt[19].pts_minus_sum}</td><td>${lt[19].pts_minus_sum}</td><td>${lt[19].points}</td>
                    </tr>
