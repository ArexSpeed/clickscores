  ...
  return false;
        ...
        selectFaq.addEventListener('change', () => {
          ...
          if (selectFaq.value == 'faq_skills') {
              faqExpl.innerHTML += `Umiejętności drużyn to najważniejszy element rozgrywki aby określić siłę danego zespołu. W symulatorze hokejowym mamy do wybrania takie skille: <br>
          ...
          if (selectFaq.value == 'faq_cups') {
              faqExpl.innerHTML += `
              Do dyspozycji są także rozgrywki pucharowe. Wybierając w "Select League" odpowiednią opcję np. "Euro" pojawiają się drużyny występujące w tych rozgrywkach. <br>Nazwy i umiejętności mozesz oczywiscie zmieniać na swoje drużyny ale kolejność uzupełniania ma znaczenie ponieważ wybrane zespoły są dzielone kolejno do odpowiednich grup tzn. pierwsze 4 drużyny do Grupy A, kolejne cztery do Grupy B, następne do Gr C itd.<br>
              `
          }
      })
        ...
        select.addEventListener('change', () => {
            ...
            if (select.value == 'cl') {
             ...
             <td><input type="number" value="${cl[i].att}" id="team${i}_att" max="99" min="1"> </td>
              <td><input type="number" value="${cl[i].def}" id="team${i}_tw" max="99" min="1"> </td>
                  <td><input type="number" value="${cl[i].tw}" id="team${i}_def" max="99" min="1"></td>
              </tr><br>
          `;
              }
          ...
          if (select.value == 'euro') {
             ...
             <td><input type="number" value="${euro[i].att}" id="team${i}_att" max="99" min="1"> </td>
              <td><input type="number" value="${euro[i].def}" id="team${i}_tw" max="99" min="1"> </td>
                  <td><input type="number" value="${euro[i].tw}" id="team${i}_def" max="99" min="1"></td>
              </tr><br>
          `;
              }
              showTeam.innerHTML += `<button onclick="accept()" id="accept" class="accept btn_effect">Accept</button>`
            ...
            if (select.value == 'pol') {
                ...
                <input type="number" value="${poland[i].def}" id="team${i}_mid" max="99" min="1"> 
                <input type="number" value="${poland[i].tw}" id="team${i}_def" max="99" min="1">
                <br>`;
                }
                showTeam.innerHTML += `</table><button onclick="accept()" id="accept" class="accept btn_effect">Accept</button>`
            }
            if (select.value == 'nhle') {
                teams.splice(0, teams.length);
                const team_qty = nhlEast.length;
                showTeam.innerHTML += `<input type="button" value="${team_qty}" id="team_qty">
                <input type="number" placeholder="Att" readonly>
                <input type="number" placeholder="Def" readonly>
                <input type="number" placeholder="TW" readonly><br>
                ...
                for (let i = 0; i < team_qty; i++) {
                    ...
                    showTeam.innerHTML += `
                <input type="text" value="${nhlEast[i].name}" id="team${i}_name" > 
                <input type="number" value="${nhlEast[i].att}" id="team${i}_att" max="99" min="1"> 
                <input type="number" value="${nhlEast[i].def}" id="team${i}_def" max="99" min="1"> 
                <input type="number" value="${nhlEast[i].tw}" id="team${i}_tw" max="99" min="1">
                <br>`;
                }
               showTeam.innerHTML += `</table><button onclick="accept()" id="accept" class="accept btn_effect">Accept</button>`
            }
            if (select.value == 'nhlw') {
                teams.splice(0, teams.length);
                const team_qty = nhlWest.length;
                showTeam.innerHTML += `<input type="button" value="${team_qty}" id="team_qty">
                <input type="number" placeholder="Att" readonly>
                <input type="number" placeholder="Def" readonly>
                <input type="number" placeholder="TW" readonly><br>
                ...
                for (let i = 0; i < team_qty; i++) {
                    ...
                    showTeam.innerHTML += `
                <input type="text" value="${nhlWest[i].name}" id="team${i}_name" > 
                <input type="number" value="${nhlWest[i].att}" id="team${i}_att" max="99" min="1"> 
                <input type="number" value="${nhlWest[i].def}" id="team${i}_def" max="99" min="1"> 
                <input type="number" value="${nhlWest[i].tw}" id="team${i}_tw" max="99" min="1">
                <br>`;
                }
               showTeam.innerHTML += `</table><button onclick="accept()" id="accept" class="accept btn_effect">Accept</button>`
            }
...
const poland4 = [{
        ...
        const nhlEast = [{
            ...
            name: 'Pittsburgh Pengiuns',
            att: 88,
            def: 90,
            tw: 88
            },{
            name: 'Carolina Hurricane',
            att: 87,
            def: 90,
            tw: 87
            },{
