...
select.addEventListener('change', () => {
    ...
    if (select.value == 'one') {
        ...
        <option value="one">One</option>
         ...
         <option value="ace">Ashton Celtic</option>
...
function play_one(a,b,c,d,h_id,r1,r2,r3,r4){
    ...
    const laps = (x) =>{
        ...
        lap1 = 0.2*((x.tech+Math.floor(Math.random()*10))+mtr1) + 1*((x.ref+Math.floor(Math.random()*10))+mtr1);
        lap2 = 0.5*((x.tech+Math.floor(Math.random()*10))+mtr2) + 0.5*((x.ref+Math.floor(Math.random()*10))+mtr2);
        lap3 = 0.5*((x.tech+Math.floor(Math.random()*10))+mtr3) + 0.3*((x.ref+Math.floor(Math.random()*10))+mtr3);
        lap4 = 0.8*((x.tech+Math.floor(Math.random()*10))+mtr4) + 0.1*((x.ref+Math.floor(Math.random()*10))+mtr4);
