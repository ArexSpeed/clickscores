        ...
        select.addEventListener('change', () => {
            ...
            if (select.value == 'ale') {
                ...
                for (let i = 0; i < team_qty; i++) {
                    ...
                    showTeam.innerHTML += `
                <input type="text" value="${aleague[i].name}" id="team${i}_name"> 
                <input type="number" value="${aleague[i].att}" id="team${i}_att" max="99" min="1"> 
                <input type="number" value="${aleague[i].mid}" id="team${i}_mid" max="99" min="1"> 
                <input type="number" value="${aleague[i].def}" id="team${i}_def" max="99" min="1">
                <br>`;
                }
                showTeam.innerHTML += `</table><button onclick="accept()" id="accept" class="accept btn_effect">Accept</button>`
            }
